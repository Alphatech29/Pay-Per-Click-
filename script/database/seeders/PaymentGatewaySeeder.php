...
class PaymentGatewaySeeder extends Seeder
{
    ...
    public function run()
    {
        $getways = array(
            ...
            "max_amount"=> 1000,'logo' => 'uploads/flutterwave.png','rate' => '54','charge' => '2','namespace' => 'App\\Lib\\Flutterwave','currency_name' => 'NGN','is_auto' => '1','image_accept' => '0','test_mode' => '1','status' => '0','phone_required' => '1','data' => '{"public_key":"","encryption_key":"","payment_options":"card"}','created_at' => now(),'updated_at' => now()),
